  ...
  $.GollumEditor = function( IncomingOptions ) {
    ...
    if ( EditorHas.baseEditorMarkup() ) {
      ...
      if ( EditorHas.collapsibleInputs() ) {
        $('#gollum-editor .collapsed a.toggler, ' +
          '#gollum-editor .expanded a.toggler').click(function( e ) {
          e.preventDefault();
          $(this).parents(".collapsed, .expanded").toggleClass('collapsed').toggleClass('expanded');
        });
      }
